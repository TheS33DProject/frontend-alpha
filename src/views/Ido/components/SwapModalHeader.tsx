...
export default function SwapModalHeader({
  ...
  // const tradeInfoText =
  //   trade.tradeType === TradeType.EXACT_INPUT
  //     ? t('Output is estimated. You will receive %amount% %symbol%.', {
  //         amount,
  //         symbol,
  //       })
  //     : t('Input is estimated. You will sell %amount% %symbol%.', {
  //         amount,
  //         symbol,
  //       })
    ...
    <AutoColumn gap="md">
      ...
      <RowBetween align="flex-end">
        <RowFixed gap="0px">
          ...
          <TruncatedText fontSize="24px" color={trade.tradeType === TradeType.EXACT_INPUT ? 'primary' : 'text'}>
