...
export const DEFAULT_META: PageMeta = {
  title: 'The S33D Project',
  description:
    'The S33D Project is about building a foundation for exchange of resources among humanity in the fairest for all.',
  image: 'https://s33d.app/images/hero.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    ...
    defaultTitleSuffix: t('The S33D Project'),
  }
}
